...
Ein `sql string` benennt einen wiederverwendbaren SQL-Text, der im gesamten Repository sichtbar ist. Er eignet sich für SQL-Fragmente, die von mehreren Repository-Methoden verwendet werden sollen; das Repository bleibt dabei zustandslos.
...
Ohne erzwingende Option prüft ManMap den Schlüssel folgendermaßen:
...
| Ergebnisform | Mapping im `SQL` | Repository-Member | Geeigneter Einsatz |
| --- | --- | --- | --- |
